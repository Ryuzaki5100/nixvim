{
  ...
  outputs = { nixvim, flake-parts, flake-utils, ... }@inputs:
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      perSystem = { system, pkgs, ... }:
        let
          ...
          lspTools = with pkgs; [
            # C / C++
            llvmPackages_18.clang-tools clang gnumake cmake gdb lldb

            # Java
            jdk21 jdt-language-server

            # Rust
            rust-analyzer rustc cargo

            # Python
            pyright ruff black python3
        ...
        in
        {
          ...
          devShells.default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Your full portable IDE is ready!"
              alias vim=nvim
              alias vi=nvim
            '';
          };
